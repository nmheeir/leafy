...
@JsonKey(name: 'id') int? get id;@JsonKey(name: 'title') String get title;@JsonKey(name: 'subtitle') String? get subtitle;@JsonKey(name: 'author') String get author;@JsonKey(fromJson: _descriptionFromJson) String? get description;@JsonKey(name: 'book_format') BookFormat get bookFormat;@JsonKey(name: 'status') BookStatus get status;@JsonKey(name: 'rating') int? get rating;@IntToBoolConverter()@JsonKey(name: 'favorite') bool get favorite;@IntToBoolConverter()@JsonKey(name: 'deleted') bool get deleted;@JsonKey(name: 'start_date') DateTime? get startDate;@JsonKey(name: 'finish_date') DateTime? get finishDate;@JsonKey(name: 'date_added') DateTime get dateAdded;@JsonKey(name: 'date_modified') DateTime get dateModified;@JsonKey(name: 'pages') int? get pages;@JsonKey(name: 'publication_year') int? get publicationYear;@JsonKey(name: 'my_review') String? get myReview;@JsonKey(name: 'notes') String? get notes;@IntToBoolConverter()@JsonKey(name: 'has_cover') bool get hasCover;@JsonKey(name: 'blur_hash') String? get blurHash;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,subtitle,author,description,bookFormat,status,rating,favorite,deleted,startDate,finishDate,dateAdded,dateModified,pages,publicationYear,myReview,notes,hasCover,blurHash]);

@override
String toString() {
  return 'BookModel(id: $id, title: $title, subtitle: $subtitle, author: $author, description: $description, bookFormat: $bookFormat, status: $status, rating: $rating, favorite: $favorite, deleted: $deleted, startDate: $startDate, finishDate: $finishDate, dateAdded: $dateAdded, dateModified: $dateModified, pages: $pages, publicationYear: $publicationYear, myReview: $myReview, notes: $notes, hasCover: $hasCover, blurHash: $blurHash)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id') int? id,@JsonKey(name: 'title') String title,@JsonKey(name: 'subtitle') String? subtitle,@JsonKey(name: 'author') String author,@JsonKey(fromJson: _descriptionFromJson) String? description,@JsonKey(name: 'book_format') BookFormat bookFormat,@JsonKey(name: 'status') BookStatus status,@JsonKey(name: 'rating') int? rating,@IntToBoolConverter()@JsonKey(name: 'favorite') bool favorite,@IntToBoolConverter()@JsonKey(name: 'deleted') bool deleted,@JsonKey(name: 'start_date') DateTime? startDate,@JsonKey(name: 'finish_date') DateTime? finishDate,@JsonKey(name: 'date_added') DateTime dateAdded,@JsonKey(name: 'date_modified') DateTime dateModified,@JsonKey(name: 'pages') int? pages,@JsonKey(name: 'publication_year') int? publicationYear,@JsonKey(name: 'my_review') String? myReview,@JsonKey(name: 'notes') String? notes,@IntToBoolConverter()@JsonKey(name: 'has_cover') bool hasCover,@JsonKey(name: 'blur_hash') String? blurHash
});
...
/// Create a copy of BookModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = null,Object? subtitle = freezed,Object? author = null,Object? description = freezed,Object? bookFormat = null,Object? status = null,Object? rating = freezed,Object? favorite = null,Object? deleted = null,Object? startDate = freezed,Object? finishDate = freezed,Object? dateAdded = null,Object? dateModified = null,Object? pages = freezed,Object? publicationYear = freezed,Object? myReview = freezed,Object? notes = freezed,Object? hasCover = null,Object? blurHash = freezed,}) {
...
as int?,myReview: freezed == myReview ? _self.myReview : myReview // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _BookModel() when $default != null:
return $default(_that.id,_that.title,_that.subtitle,_that.author,_that.description,_that.bookFormat,_that.status,_that.rating,_that.favorite,_that.deleted,_that.startDate,_that.finishDate,_that.dateAdded,_that.dateModified,_that.pages,_that.publicationYear,_that.myReview,_that.notes,_that.hasCover,_that.blurHash);case _:
  return orElse();
...
class _BookModel extends BookModel {
  const _BookModel({@JsonKey(name: 'id') this.id, @JsonKey(name: 'title') required this.title, @JsonKey(name: 'subtitle') this.subtitle, @JsonKey(name: 'author') required this.author, @JsonKey(fromJson: _descriptionFromJson) this.description, @JsonKey(name: 'book_format') this.bookFormat = BookFormat.paperback, @JsonKey(name: 'status') this.status = BookStatus.finished, @JsonKey(name: 'rating') this.rating, @IntToBoolConverter()@JsonKey(name: 'favorite') this.favorite = false, @IntToBoolConverter()@JsonKey(name: 'deleted') this.deleted = false, @JsonKey(name: 'start_date') this.startDate, @JsonKey(name: 'finish_date') this.finishDate, @JsonKey(name: 'date_added') required this.dateAdded, @JsonKey(name: 'date_modified') required this.dateModified, @JsonKey(name: 'pages') this.pages, @JsonKey(name: 'publication_year') this.publicationYear, @JsonKey(name: 'my_review') this.myReview, @JsonKey(name: 'notes') this.notes, @IntToBoolConverter()@JsonKey(name: 'has_cover') this.hasCover = false, @JsonKey(name: 'blur_hash') this.blurHash}): super._();
...
@override@JsonKey(name: 'book_format') final  BookFormat bookFormat;
