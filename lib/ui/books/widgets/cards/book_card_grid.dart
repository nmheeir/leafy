...
class BookCardGrid extends StatelessWidget {
      ...
      child: InkWell(
        ...
        child: ClipRRect(
          ...
          child: coverFile != null
              ? _buildCardWithCover(heroTag: heroTag, file: coverFile)
              : _buildCardWithoutCover(book: book, context: context),
        ),
      ),
    );
  }
  ...
  Widget _buildCardWithoutCover({
    ...
    return Stack(
      children: [
        const Positioned.fill(child: ImagePlaceholder(borderRadius: 8)),
        Container(
