...
class SettingDefaultBookTagScreen extends StatelessWidget {
  SettingDefaultBookTagScreen({super.key});
  final _searchController = TextEditingController();

  void onTagChipPressed(BuildContext context, String tag) {
    FocusScope.of(context).unfocus();
    context.read<DefaultBookTagCubit>().updateTag(tag);
  }
  ...
  void _submitNewTag(BuildContext context, String input) {
    ...
    context.read<DefaultBookTagCubit>().updateTag(newTag);
