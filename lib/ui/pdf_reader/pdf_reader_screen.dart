...
import 'package:leafy/ui/pdf_reader/widgets/password_dialog.dart';
import 'package:leafy/ui/pdf_reader/widgets/search_view.dart';
...
class _PdfReaderScreenState extends State<PdfReaderScreen>
  ...
  late final List<PdfPageLayoutFunction?> _layoutPages = [
    ...
    // Horizontal layout (using manual calculation since SequentialPagesLayout is missing)
    (pages, params) {
      final height =
    ...
    // Facing pages layout (disabled - FacingPagesLayout is missing)
  ...
  Future<void> openInitialFile({bool useProgressiveLoading = true}) async {
    ...
    documentRef.value = PdfDocumentRefAsset(
