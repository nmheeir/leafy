...
class DuckDuckGoAlert extends StatelessWidget {
  const DuckDuckGoAlert({super.key, required this.openDuckDuckGoSearchScreen});

  final Function(BuildContext) openDuckDuckGoSearchScreen;

  void _yesButtonAction(BuildContext context) {
    Navigator.of(context).pop();

    openDuckDuckGoSearchScreen(context);
  }

  Future<void> _yesAndDontShowButtonAction(BuildContext context) async {
    Navigator.of(context).pop();
  ...
  void _noButtonAction(BuildContext context) {
    Navigator.of(context).pop();
  }
  ...
  Widget _buildAndroidYesButton(BuildContext context) {
    return FilledButton.tonal(
      ...
      child: Padding(
        ...
        child: Text(LocaleKeys.warning_yes.tr(), textAlign: TextAlign.end),
      ),
    );
  }
