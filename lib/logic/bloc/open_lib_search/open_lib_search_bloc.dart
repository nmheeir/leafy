...
part 'open_lib_search_bloc.freezed.dart';
...
class OpenLibSearchBloc extends Bloc<OpenLibSearchEvent, OpenLibSearchState> {
  ...
  OpenLibSearchBloc(this._openLibSearchUseCase, this._logger)
    : super(const OpenLibSearchState()) {
  ...
  void _onTypeChanged(_TypeChanged event, Emitter<OpenLibSearchState> emit) {
    ...
    if (hasValidCache) {
      ...
      if (currentQuery.isNotEmpty) {
        ...
        add(OpenLibSearchEvent.queryChanged(currentQuery));
      } else {
