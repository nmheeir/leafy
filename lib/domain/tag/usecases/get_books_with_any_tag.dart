...
@injectable
class GetBooksWithAnyTagUseCase implements UseCase<List<Book>, List<int>> {
  final BookTagRepository _repository;

  const GetBooksWithAnyTagUseCase(this._repository);

  @override
  Future<Either<Failure, List<Book>>> call(List<int> params) async {
    return _repository.getBooksWithAnyTag(params);
  }
}
