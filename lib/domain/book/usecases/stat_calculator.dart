...
class StatsCalculator {
  ...
  StatsResult calculate(List<Book> books) {
    ...
    return StatsResult(
      ...
      finishedBooksByMonthAllTypes: _getFinishedBooksByMonth(
        finishedBooks,
        null,
        years,
      ),
      finishedBooksByMonthPaperbackBooks: _getFinishedBooksByMonth(
        finishedBooks,
        BookFormat.paperback,
        years,
      ),
      finishedBooksByMonthHardcoverBooks: _getFinishedBooksByMonth(
        finishedBooks,
        BookFormat.hardcover,
        years,
      ),
      finishedBooksByMonthEbooks: _getFinishedBooksByMonth(
        finishedBooks,
        BookFormat.ebook,
        years,
      ),
      finishedBooksByMonthAudiobooks: _getFinishedBooksByMonth(
        finishedBooks,
        BookFormat.audiobook,
        years,
      ),

      finishedPagesByMonthAllTypes: _getFinishedPagesByMonth(
        finishedBooks,
        null,
        years,
      ),
      finishedPagesByMonthPaperbackBooks: _getFinishedPagesByMonth(
        finishedBooks,
        BookFormat.paperback,
        years,
      ),
      finishedPagesByMonthHardcoverBooks: _getFinishedPagesByMonth(
        finishedBooks,
        BookFormat.hardcover,
        years,
      ),
      finishedPagesByMonthEbooks: _getFinishedPagesByMonth(
        finishedBooks,
        BookFormat.ebook,
        years,
      ),
      finishedPagesByMonthAudiobooks: _getFinishedPagesByMonth(
        finishedBooks,
        BookFormat.audiobook,
        years,
      ),

      finishedBooksAll: _countFinishedBooks(finishedBooks),
      finishedPagesAll: _countFinishedPages(finishedBooks),

      averageRating: _getAverageRating(finishedBooks, years),
      averagePages: _getAveragePages(finishedBooks, years),
      // averageReadingTime: _getAverageReadingTime(finishedBooks, years),
      averageReadingTime: [],

      longestBook: _getLongestBook(finishedBooks, years),
      shortestBook: _getShortestBook(finishedBooks, years),
      // fastestBook: _getFastestReadBook(finishedBooks, years),
      // slowestBook: _getSlowestReadBooks(finishedBooks, years),
      fastestBook: [],
      slowestBook: [],
    );
  }
  ...
  //         readTimeInMs = ReadingTime.toMilliSeconds(
  //           readTimeinDays,
  //           0,
  //           0,
  //         ).milliSeconds;
  ...
  //     bookYearlyStats.add(
  //       BookYearlyStat(year: year, value: averageReadingTimeInAYear),
  //     );
  //   }
  ...
  //         final timeDifference = ReadingTime.toMilliSeconds(
  //           readTimeinDays,
  //           0,
  //           0,
  //         ).milliSeconds;
  ...
  List<BookYearlyStat> _getAveragePages(List<Book> books, List<int> years) {
    ...
    for (var year in years) {
      bookYearlyStats.add(
        BookYearlyStat(year: year, value: _getAveragePagesInYear(books, year)),
      );
    }
  ...
  List<BookYearlyStat> _getAverageRating(List<Book> books, List<int> years) {
    ...
    for (var year in years) {
      bookYearlyStats.add(
        BookYearlyStat(year: year, value: _getAverageRatingInYear(books, year)),
      );
    }
  ...
  List<BookReadStat> _getFinishedBooksByMonth(
    ...
    for (var year in years) {
      bookReadStats.add(
        BookReadStat(
          year: year,
          values: _getFinishedBooksInSpecificMonths(books, bookType, year),
        ),
      );
    }
